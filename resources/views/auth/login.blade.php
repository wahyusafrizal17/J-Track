...
<head>
    ...
    <meta name="keywords" content="stok, produk, inventory, penjualan, aplikasi stok">
    <meta name="author" content="Wahyu Safrizal">
    <title>Aplikasi Stok Produk - Login</title>
                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="https://jubelio.com/wp-content/uploads/2025/05/Landing-Page-Aplikasi-Stok-Barang-scaled.png" alt="Login V2" /></div>
                        </div>
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Track</h2>
                                <p class="card-text mb-2">Silakan login untuk mengelola stok dan penjualan barang.</p>
